...
layout = header(), dbc.Container([
    dbc.Row([
        dbc.Col(html.H1("DATA ANALYSIS", className="text-center mb-4",style={"color":"#000000"}), width=12)
    ]),
    dbc.Row([
...
], className="my-4", style={"max-width": "1200px", "background-color": "#f5f5f5", "padding": "20px", "border-radius": "15px", "box-shadow": "0 4px 8px 0 rgba(0,0,0,0.2)"})
